...
var Struct = (function(globalThis) {
    'use strict';
    const {DataView, TextEncoder, TextDecoder, Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, BigInt64Array, BigUint64Array, Float16Array, Float32Array, Float64Array, Proxy, Reflect, Atomics, SharedArrayBuffer, ArrayBuffer} = globalThis;
